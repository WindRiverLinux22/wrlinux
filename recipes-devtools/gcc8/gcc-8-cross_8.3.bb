...
do_gcc8_stash_builddir[dirs] = "${B}"
do_gcc8_stash_builddir[cleandirs] = "${BUILDDIRSTASH}"
do_gcc8_stash_builddir () {
	dest=${BUILDDIRSTASH}
	hardlinkdir . $dest
...
addtask do_gcc8_stash_builddir after do_compile before do_install
SSTATETASKS += "do_gcc8_stash_builddir"
do_gcc8_stash_builddir[sstate-inputdirs] = "${BUILDDIRSTASH}"
do_gcc8_stash_builddir[sstate-outputdirs] = "${COMPONENTS_DIR}/${BUILD_ARCH}/gcc8-stashed-builddir-${TARGET_SYS}"
do_gcc8_stash_builddir[sstate-fixmedir] = "${COMPONENTS_DIR}/${BUILD_ARCH}/gcc8-stashed-builddir-${TARGET_SYS}"

python do_gcc8_stash_builddir_setscene () {
    sstate_setscene(d)
}
addtask do_gcc8_stash_builddir_setscene
